...
@BeforeTest
		public void lauchapp(){
			System.setProperty("webdriver.chrome.driver", "E:\\FYND ACADEMY\\Jars\\chromedriver.exe");
...
public void storeUrls() throws Exception {
	FileOutputStream fo = new FileOutputStream("C:\\Users\\HP\\Desktop\\data.xls");
...
FileInputStream f = new FileInputStream("C:\\Users\\HP\\Desktop\\data.xls");
...
String FootballCont = s.getCell(1, 0).getContents();
